...
let impossibleBeliefs = impossibleBeliefsCount(pigsFlying: 7, frogsBecomingPrinces: 12, multipleLightningStrikes: 72)
impossibleThingsPhrase(numberOfImpossibleThings: impossibleBeliefs, meal: "breakfast")
