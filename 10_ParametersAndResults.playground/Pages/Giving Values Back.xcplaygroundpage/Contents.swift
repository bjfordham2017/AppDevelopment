...
*/
func returnFavorite(category: String, favorite: String) -> String {
    return "My favorite \(category) is \(favorite)."
}

returnFavorite(category: "city", favorite: "Paris")
...
let favoriteShow = returnFavorite(category: "tv show", favorite: "Orphan Black")
let favoriteCity = returnFavorite(category: "city", favorite: "Paris")
let favoriteFood = returnFavorite(category: "food", favorite: "just about anything Italian")
...
print("Hello, my name is Brent. \(favoriteShow) \(favoriteCity) \(favoriteFood)")
