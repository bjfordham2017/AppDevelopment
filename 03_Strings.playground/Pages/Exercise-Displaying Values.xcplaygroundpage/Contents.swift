...
let minutesUntilFull = availableStorage / oneMinuteOfVideo

let minutesLeftReport = "You can record \(minutesUntilFull) more minutes of video."
print(minutesLeftReport)
