...
var place: String = "my happy place"
var animal: String = "cat"
var verb: String = "prancing"

let madLibStory = "The strangest thing happened on the way to \(place) today.  I saw a large \(animal) \(verb) on the roof of another car."
//:
//:
