...
let morningRoutine = brushTeeth + checkPhone + workOut + shower + getDressed + gatherStuff + sayByeToFam
...
let thingsILike = checkPhone + workOut + sayByeToFam

let thingsIHaveToDo = brushTeeth + shower + getDressed + gatherStuff

let imActuallyPrettyHappyWithMyMorningRoutine = morningRoutine
